...
class Process:
    def __init__(self, name, runtime, priority, create_time, cpu_usage, memory_info):
        self.name = name
...
def multilevel_queue_scheduling(processes, time_quantum_low, time_quantum_high):
    ...
    priority_queue_scheduling(high_priority_queue)
...
if __name__ == "__main__":
    ...
    for process in system_processes:
        ...
        if best_suggestion.startswith("Shortest Job First"):
            ...
            priority_queue_scheduling(processes_ljf)
